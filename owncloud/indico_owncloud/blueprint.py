...
from indico_owncloud.controllers import (RHAddCategoryAttachmentOwncloud, RHAddEventAttachmentOwncloud,
                                         RHOwncloudAuthCallback, RHOwncloudAuthRenewCallback)
...
blueprint.add_url_rule('/owncloud-auth-callback', 'owncloud_auth_callback', RHOwncloudAuthCallback)
blueprint.add_url_rule('/owncloud-auth-renew-callback', 'owncloud_auth_renew_callback',
                       RHOwncloudAuthRenewCallback)
